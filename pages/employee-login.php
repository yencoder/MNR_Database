...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->rowCount() > 0) {
        ...
        if ($password == $user['password']) {
            ...
            // Redirect to the appropriate home page based on the department
            if ($user['department'] === 'CLTIP') {
                header('Location: CLTIP_home.php');
            } elseif ($user['department'] === 'MFTIP') {
                header('Location: MFTIP_home.php');
            } else {
    ...
    <div class="main-content">
        <main>
            <section class="login-form">
                <h2>MNRF CLTIP & MFTIP Employee Login</h2>
                <form method="POST">
