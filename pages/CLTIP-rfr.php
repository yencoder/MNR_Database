...
if (isset($_POST['rNumber'])) {
    ...
    $query = "SELECT * FROM appeal_parcels WHERE program = 'CLTIP - Conservation Land Tax Incentive Program' AND ARN='" . $rNumber . "' AND Status='Active'";
    $query2 = "SELECT * FROM appeal_parcels WHERE program = 'CLTIP - Conservation Land Tax Incentive Program' AND ARN='" . $rNumber . "' AND Status='Completed'";
} else if (isset($_POST['landlordName'])) {
    $landlordName = $_POST['landlordName'];
    $query = "SELECT * FROM appeal_parcels WHERE program = 'CLTIP - Conservation Land Tax Incentive Program' AND Owner='" . $landlordName . "' AND Status='Active'";
    $query2 = "SELECT * FROM appeal_parcels WHERE program = 'CLTIP - Conservation Land Tax Incentive Program' AND Owner='" . $landlordName . "' AND Status='Completed'";
} else {
    // query for default view from pendingrfr table
    $query = "select * from appeal_parcels where program = 'CLTIP - Conservation Land Tax Incentive Program' AND Status='Active' ";
    $query2 = "select * from appeal_parcels where program = 'CLTIP - Conservation Land Tax Incentive Program' AND Status='Completed' ";
}
